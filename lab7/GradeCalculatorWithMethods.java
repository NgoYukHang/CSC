...
//NGO YUK HANG 228991 LAB 7 Q3
public class GradeCalculatorWithMethods{

	public static Scanner scanner = new Scanner(System.in);
	public static int input;

	public static String[] markMessages = {
	...
	public static int[] percentages = new int[4];
	...
	public static void getMarksFromInput(){
	...
	public static void getTotalPercentage(){
